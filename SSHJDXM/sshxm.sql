...
Source Database       : sshxm

Target Server Type    : MYSQL
Target Server Version : 50519
File Encoding         : 65001

Date: 2018-01-02 19:49:08
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for adminadminrolse
-- ----------------------------
DROP TABLE IF EXISTS `adminadminrolse`;
CREATE TABLE `adminadminrolse` (
  `admins` int(11) NOT NULL,
  `adminroles` int(255) NOT NULL,
  PRIMARY KEY (`admins`,`adminroles`),
  KEY `adminroles` (`adminroles`),
  CONSTRAINT `adminadminrolse_ibfk_1` FOREIGN KEY (`admins`) REFERENCES `admins` (`id`),
  CONSTRAINT `adminadminrolse_ibfk_2` FOREIGN KEY (`adminroles`) REFERENCES `adminroles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of adminadminrolse
-- ----------------------------
INSERT INTO `adminadminrolse` VALUES ('1', '1');
INSERT INTO `adminadminrolse` VALUES ('8', '1');
INSERT INTO `adminadminrolse` VALUES ('9', '1');
INSERT INTO `adminadminrolse` VALUES ('2', '19');
INSERT INTO `adminadminrolse` VALUES ('11', '19');
INSERT INTO `adminadminrolse` VALUES ('3', '20');
INSERT INTO `adminadminrolse` VALUES ('11', '20');
INSERT INTO `adminadminrolse` VALUES ('12', '20');
INSERT INTO `adminadminrolse` VALUES ('14', '20');
INSERT INTO `adminadminrolse` VALUES ('16', '20');
INSERT INTO `adminadminrolse` VALUES ('17', '20');
INSERT INTO `adminadminrolse` VALUES ('19', '20');
INSERT INTO `adminadminrolse` VALUES ('6', '21');
INSERT INTO `adminadminrolse` VALUES ('11', '21');
INSERT INTO `adminadminrolse` VALUES ('15', '21');
INSERT INTO `adminadminrolse` VALUES ('18', '21');
INSERT INTO `adminadminrolse` VALUES ('4', '22');
INSERT INTO `adminadminrolse` VALUES ('5', '23');
INSERT INTO `adminadminrolse` VALUES ('8', '26');
INSERT INTO `adminadminrolse` VALUES ('8', '27');
INSERT INTO `adminadminrolse` VALUES ('13', '27');
...
CREATE TABLE `adminroles` (
  ...
  `moditfydate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `adminroles` VALUES ('1', '超级管理员', '拥有后台系统最高权限', '2017-12-22 08:54:36', '2017-12-29 21:09:20');
INSERT INTO `adminroles` VALUES ('19', '前台角色', '拥有前台所有权限', '2017-12-25 08:54:55', '2017-12-27 15:56:41');
INSERT INTO `adminroles` VALUES ('20', '会员角色', '拥有会员的增删改查权限', '2017-12-25 09:01:49', '2017-12-27 15:56:48');
INSERT INTO `adminroles` VALUES ('21', '员工管理', '拥有员工的增删改查权限', '2017-12-25 09:03:24', '2017-12-27 15:56:55');
INSERT INTO `adminroles` VALUES ('22', '仓库管理', '拥有仓库采购、维修、维护仓库、库存、供应商等权限', '2017-12-25 09:06:19', '2017-12-27 15:57:02');
INSERT INTO `adminroles` VALUES ('23', '财务管理', '拥有财务增删改查，以及审核采购单等权限', '2017-12-25 09:07:43', '2017-12-27 15:57:09');
INSERT INTO `adminroles` VALUES ('25', '测试角色2', '在市场细分大V', '2017-12-25 09:09:12', null);
INSERT INTO `adminroles` VALUES ('26', '测试角色3', '许v过vv吧v吧v吧', '2017-12-25 09:09:26', null);
INSERT INTO `adminroles` VALUES ('27', 'v的地方发布大风', '大幅波动真幸福', '2017-12-25 09:09:40', '2017-12-29 11:24:08');
INSERT INTO `adminroles` VALUES ('28', '分享给你幸福吗哪些方面', 'v地方的政府不会做的饭', '2017-12-25 09:09:54', '2017-12-29 11:12:43');
INSERT INTO `adminroles` VALUES ('29', 'wwwwwwwwww', 'w哈哈的法律框架爱好离开教室的', '2017-12-25 13:43:09', '2017-12-29 11:08:07');
INSERT INTO `adminroles` VALUES ('30', 'sfsd', 'fbdzxfhb', '2017-12-29 11:23:52', null);

-- ----------------------------
-- Table structure for adminrolesper
-- ----------------------------
DROP TABLE IF EXISTS `adminrolesper`;
CREATE TABLE `adminrolesper` (
  `adminroles` int(11) NOT NULL,
  `permission` int(11) NOT NULL,
  PRIMARY KEY (`adminroles`,`permission`),
  KEY `permission` (`permission`),
  CONSTRAINT `adminrolesper_ibfk_1` FOREIGN KEY (`adminroles`) REFERENCES `adminroles` (`id`),
  CONSTRAINT `adminrolesper_ibfk_2` FOREIGN KEY (`permission`) REFERENCES `permission` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of adminrolesper
-- ----------------------------
INSERT INTO `adminrolesper` VALUES ('1', '1');
INSERT INTO `adminrolesper` VALUES ('19', '1');
INSERT INTO `adminrolesper` VALUES ('29', '1');
INSERT INTO `adminrolesper` VALUES ('1', '2');
INSERT INTO `adminrolesper` VALUES ('19', '2');
INSERT INTO `adminrolesper` VALUES ('29', '2');
INSERT INTO `adminrolesper` VALUES ('1', '3');
INSERT INTO `adminrolesper` VALUES ('19', '3');
INSERT INTO `adminrolesper` VALUES ('1', '4');
INSERT INTO `adminrolesper` VALUES ('19', '4');
INSERT INTO `adminrolesper` VALUES ('1', '5');
INSERT INTO `adminrolesper` VALUES ('19', '5');
INSERT INTO `adminrolesper` VALUES ('1', '6');
INSERT INTO `adminrolesper` VALUES ('19', '6');
INSERT INTO `adminrolesper` VALUES ('1', '7');
INSERT INTO `adminrolesper` VALUES ('19', '7');
INSERT INTO `adminrolesper` VALUES ('1', '8');
INSERT INTO `adminrolesper` VALUES ('19', '8');
INSERT INTO `adminrolesper` VALUES ('1', '9');
INSERT INTO `adminrolesper` VALUES ('19', '9');
INSERT INTO `adminrolesper` VALUES ('1', '10');
INSERT INTO `adminrolesper` VALUES ('19', '10');
INSERT INTO `adminrolesper` VALUES ('1', '11');
INSERT INTO `adminrolesper` VALUES ('19', '11');
INSERT INTO `adminrolesper` VALUES ('1', '12');
INSERT INTO `adminrolesper` VALUES ('19', '12');
INSERT INTO `adminrolesper` VALUES ('1', '13');
INSERT INTO `adminrolesper` VALUES ('19', '13');
INSERT INTO `adminrolesper` VALUES ('1', '14');
INSERT INTO `adminrolesper` VALUES ('19', '14');
INSERT INTO `adminrolesper` VALUES ('1', '15');
INSERT INTO `adminrolesper` VALUES ('19', '15');
INSERT INTO `adminrolesper` VALUES ('1', '16');
INSERT INTO `adminrolesper` VALUES ('19', '16');
INSERT INTO `adminrolesper` VALUES ('1', '17');
INSERT INTO `adminrolesper` VALUES ('19', '17');
INSERT INTO `adminrolesper` VALUES ('1', '18');
INSERT INTO `adminrolesper` VALUES ('19', '18');
INSERT INTO `adminrolesper` VALUES ('1', '19');
INSERT INTO `adminrolesper` VALUES ('19', '19');
INSERT INTO `adminrolesper` VALUES ('1', '20');
INSERT INTO `adminrolesper` VALUES ('19', '20');
INSERT INTO `adminrolesper` VALUES ('1', '21');
INSERT INTO `adminrolesper` VALUES ('19', '21');
INSERT INTO `adminrolesper` VALUES ('1', '22');
INSERT INTO `adminrolesper` VALUES ('19', '22');
INSERT INTO `adminrolesper` VALUES ('1', '23');
INSERT INTO `adminrolesper` VALUES ('19', '23');
INSERT INTO `adminrolesper` VALUES ('1', '24');
INSERT INTO `adminrolesper` VALUES ('19', '24');
INSERT INTO `adminrolesper` VALUES ('1', '25');
INSERT INTO `adminrolesper` VALUES ('19', '25');
INSERT INTO `adminrolesper` VALUES ('1', '26');
INSERT INTO `adminrolesper` VALUES ('19', '26');
INSERT INTO `adminrolesper` VALUES ('1', '27');
INSERT INTO `adminrolesper` VALUES ('19', '27');
INSERT INTO `adminrolesper` VALUES ('1', '28');
INSERT INTO `adminrolesper` VALUES ('19', '28');
INSERT INTO `adminrolesper` VALUES ('1', '29');
INSERT INTO `adminrolesper` VALUES ('19', '29');
INSERT INTO `adminrolesper` VALUES ('1', '30');
INSERT INTO `adminrolesper` VALUES ('19', '30');
INSERT INTO `adminrolesper` VALUES ('1', '31');
INSERT INTO `adminrolesper` VALUES ('19', '31');
INSERT INTO `adminrolesper` VALUES ('1', '32');
INSERT INTO `adminrolesper` VALUES ('19', '32');
INSERT INTO `adminrolesper` VALUES ('1', '33');
INSERT INTO `adminrolesper` VALUES ('19', '33');
INSERT INTO `adminrolesper` VALUES ('1', '34');
INSERT INTO `adminrolesper` VALUES ('20', '34');
INSERT INTO `adminrolesper` VALUES ('26', '34');
INSERT INTO `adminrolesper` VALUES ('27', '34');
INSERT INTO `adminrolesper` VALUES ('1', '35');
INSERT INTO `adminrolesper` VALUES ('20', '35');
INSERT INTO `adminrolesper` VALUES ('26', '35');
INSERT INTO `adminrolesper` VALUES ('27', '35');
INSERT INTO `adminrolesper` VALUES ('1', '36');
INSERT INTO `adminrolesper` VALUES ('20', '36');
INSERT INTO `adminrolesper` VALUES ('26', '36');
INSERT INTO `adminrolesper` VALUES ('27', '36');
INSERT INTO `adminrolesper` VALUES ('1', '37');
INSERT INTO `adminrolesper` VALUES ('20', '37');
INSERT INTO `adminrolesper` VALUES ('26', '37');
INSERT INTO `adminrolesper` VALUES ('27', '37');
INSERT INTO `adminrolesper` VALUES ('1', '38');
INSERT INTO `adminrolesper` VALUES ('20', '38');
INSERT INTO `adminrolesper` VALUES ('26', '38');
INSERT INTO `adminrolesper` VALUES ('27', '38');
INSERT INTO `adminrolesper` VALUES ('1', '39');
INSERT INTO `adminrolesper` VALUES ('21', '39');
INSERT INTO `adminrolesper` VALUES ('27', '39');
INSERT INTO `adminrolesper` VALUES ('28', '39');
INSERT INTO `adminrolesper` VALUES ('30', '39');
INSERT INTO `adminrolesper` VALUES ('1', '40');
INSERT INTO `adminrolesper` VALUES ('21', '40');
INSERT INTO `adminrolesper` VALUES ('27', '40');
INSERT INTO `adminrolesper` VALUES ('28', '40');
INSERT INTO `adminrolesper` VALUES ('30', '40');
INSERT INTO `adminrolesper` VALUES ('1', '41');
INSERT INTO `adminrolesper` VALUES ('21', '41');
INSERT INTO `adminrolesper` VALUES ('27', '41');
INSERT INTO `adminrolesper` VALUES ('28', '41');
INSERT INTO `adminrolesper` VALUES ('30', '41');
INSERT INTO `adminrolesper` VALUES ('1', '42');
INSERT INTO `adminrolesper` VALUES ('21', '42');
INSERT INTO `adminrolesper` VALUES ('27', '42');
INSERT INTO `adminrolesper` VALUES ('28', '42');
INSERT INTO `adminrolesper` VALUES ('30', '42');
INSERT INTO `adminrolesper` VALUES ('1', '43');
INSERT INTO `adminrolesper` VALUES ('21', '43');
INSERT INTO `adminrolesper` VALUES ('27', '43');
INSERT INTO `adminrolesper` VALUES ('28', '43');
INSERT INTO `adminrolesper` VALUES ('30', '43');
INSERT INTO `adminrolesper` VALUES ('1', '44');
INSERT INTO `adminrolesper` VALUES ('22', '44');
INSERT INTO `adminrolesper` VALUES ('1', '45');
INSERT INTO `adminrolesper` VALUES ('22', '45');
INSERT INTO `adminrolesper` VALUES ('1', '46');
INSERT INTO `adminrolesper` VALUES ('22', '46');
INSERT INTO `adminrolesper` VALUES ('1', '47');
INSERT INTO `adminrolesper` VALUES ('22', '47');
INSERT INTO `adminrolesper` VALUES ('1', '48');
INSERT INTO `adminrolesper` VALUES ('22', '48');
INSERT INTO `adminrolesper` VALUES ('1', '49');
INSERT INTO `adminrolesper` VALUES ('22', '49');
INSERT INTO `adminrolesper` VALUES ('1', '50');
INSERT INTO `adminrolesper` VALUES ('22', '50');
INSERT INTO `adminrolesper` VALUES ('1', '51');
INSERT INTO `adminrolesper` VALUES ('22', '51');
INSERT INTO `adminrolesper` VALUES ('1', '52');
INSERT INTO `adminrolesper` VALUES ('22', '52');
INSERT INTO `adminrolesper` VALUES ('1', '53');
INSERT INTO `adminrolesper` VALUES ('22', '53');
INSERT INTO `adminrolesper` VALUES ('1', '54');
INSERT INTO `adminrolesper` VALUES ('22', '54');
INSERT INTO `adminrolesper` VALUES ('1', '55');
INSERT INTO `adminrolesper` VALUES ('22', '55');
INSERT INTO `adminrolesper` VALUES ('1', '56');
INSERT INTO `adminrolesper` VALUES ('22', '56');
INSERT INTO `adminrolesper` VALUES ('1', '57');
INSERT INTO `adminrolesper` VALUES ('22', '57');
INSERT INTO `adminrolesper` VALUES ('1', '58');
INSERT INTO `adminrolesper` VALUES ('22', '58');
INSERT INTO `adminrolesper` VALUES ('1', '59');
INSERT INTO `adminrolesper` VALUES ('22', '59');
INSERT INTO `adminrolesper` VALUES ('1', '60');
INSERT INTO `adminrolesper` VALUES ('22', '60');
INSERT INTO `adminrolesper` VALUES ('1', '61');
INSERT INTO `adminrolesper` VALUES ('22', '61');
INSERT INTO `adminrolesper` VALUES ('1', '62');
INSERT INTO `adminrolesper` VALUES ('22', '62');
INSERT INTO `adminrolesper` VALUES ('1', '63');
INSERT INTO `adminrolesper` VALUES ('22', '63');
INSERT INTO `adminrolesper` VALUES ('1', '64');
INSERT INTO `adminrolesper` VALUES ('22', '64');
INSERT INTO `adminrolesper` VALUES ('1', '65');
INSERT INTO `adminrolesper` VALUES ('22', '65');
INSERT INTO `adminrolesper` VALUES ('1', '66');
INSERT INTO `adminrolesper` VALUES ('22', '66');
INSERT INTO `adminrolesper` VALUES ('1', '67');
INSERT INTO `adminrolesper` VALUES ('22', '67');
INSERT INTO `adminrolesper` VALUES ('1', '68');
INSERT INTO `adminrolesper` VALUES ('22', '68');
INSERT INTO `adminrolesper` VALUES ('1', '69');
INSERT INTO `adminrolesper` VALUES ('22', '69');
INSERT INTO `adminrolesper` VALUES ('1', '70');
INSERT INTO `adminrolesper` VALUES ('22', '70');
INSERT INTO `adminrolesper` VALUES ('1', '71');
INSERT INTO `adminrolesper` VALUES ('22', '71');
INSERT INTO `adminrolesper` VALUES ('1', '72');
INSERT INTO `adminrolesper` VALUES ('22', '72');
INSERT INTO `adminrolesper` VALUES ('1', '73');
INSERT INTO `adminrolesper` VALUES ('22', '73');
INSERT INTO `adminrolesper` VALUES ('1', '74');
INSERT INTO `adminrolesper` VALUES ('23', '74');
INSERT INTO `adminrolesper` VALUES ('25', '74');
INSERT INTO `adminrolesper` VALUES ('1', '75');
INSERT INTO `adminrolesper` VALUES ('23', '75');
INSERT INTO `adminrolesper` VALUES ('25', '75');
INSERT INTO `adminrolesper` VALUES ('1', '76');
INSERT INTO `adminrolesper` VALUES ('23', '76');
INSERT INTO `adminrolesper` VALUES ('25', '76');
INSERT INTO `adminrolesper` VALUES ('1', '77');
INSERT INTO `adminrolesper` VALUES ('23', '77');
INSERT INTO `adminrolesper` VALUES ('25', '77');
INSERT INTO `adminrolesper` VALUES ('1', '78');
INSERT INTO `adminrolesper` VALUES ('23', '78');
INSERT INTO `adminrolesper` VALUES ('25', '78');
INSERT INTO `adminrolesper` VALUES ('1', '79');
INSERT INTO `adminrolesper` VALUES ('23', '79');
INSERT INTO `adminrolesper` VALUES ('25', '79');
INSERT INTO `adminrolesper` VALUES ('1', '80');
INSERT INTO `adminrolesper` VALUES ('23', '80');
INSERT INTO `adminrolesper` VALUES ('25', '80');
INSERT INTO `adminrolesper` VALUES ('1', '81');
INSERT INTO `adminrolesper` VALUES ('23', '81');
INSERT INTO `adminrolesper` VALUES ('25', '81');
INSERT INTO `adminrolesper` VALUES ('1', '82');
INSERT INTO `adminrolesper` VALUES ('23', '82');
INSERT INTO `adminrolesper` VALUES ('25', '82');
INSERT INTO `adminrolesper` VALUES ('1', '83');
INSERT INTO `adminrolesper` VALUES ('23', '83');
INSERT INTO `adminrolesper` VALUES ('25', '83');
INSERT INTO `adminrolesper` VALUES ('1', '84');
INSERT INTO `adminrolesper` VALUES ('1', '85');
INSERT INTO `adminrolesper` VALUES ('29', '85');
INSERT INTO `adminrolesper` VALUES ('1', '86');
INSERT INTO `adminrolesper` VALUES ('1', '87');
INSERT INTO `adminrolesper` VALUES ('1', '88');
INSERT INTO `adminrolesper` VALUES ('1', '89');
INSERT INTO `adminrolesper` VALUES ('1', '90');
INSERT INTO `adminrolesper` VALUES ('1', '91');
INSERT INTO `adminrolesper` VALUES ('1', '92');
INSERT INTO `adminrolesper` VALUES ('1', '93');
INSERT INTO `adminrolesper` VALUES ('1', '94');
INSERT INTO `adminrolesper` VALUES ('1', '95');
INSERT INTO `adminrolesper` VALUES ('1', '96');
INSERT INTO `adminrolesper` VALUES ('19', '96');
INSERT INTO `adminrolesper` VALUES ('1', '97');
INSERT INTO `adminrolesper` VALUES ('1', '98');
INSERT INTO `adminrolesper` VALUES ('1', '99');
INSERT INTO `adminrolesper` VALUES ('1', '100');
INSERT INTO `adminrolesper` VALUES ('1', '101');
INSERT INTO `adminrolesper` VALUES ('1', '102');
INSERT INTO `adminrolesper` VALUES ('1', '103');
INSERT INTO `adminrolesper` VALUES ('1', '104');
INSERT INTO `adminrolesper` VALUES ('1', '105');
INSERT INTO `adminrolesper` VALUES ('1', '106');
INSERT INTO `adminrolesper` VALUES ('1', '107');
INSERT INTO `adminrolesper` VALUES ('27', '107');
INSERT INTO `adminrolesper` VALUES ('1', '108');
INSERT INTO `adminrolesper` VALUES ('1', '109');
INSERT INTO `adminrolesper` VALUES ('1', '110');
INSERT INTO `adminrolesper` VALUES ('1', '111');
INSERT INTO `adminrolesper` VALUES ('1', '112');
INSERT INTO `adminrolesper` VALUES ('1', '113');
INSERT INTO `adminrolesper` VALUES ('1', '114');
...
CREATE TABLE `admins` (
  ...
  PRIMARY KEY (`id`),
  KEY `staffs` (`staffs`),
  CONSTRAINT `admins_ibfk_1` FOREIGN KEY (`staffs`) REFERENCES `staffs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES ('1', '1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2018-01-02 19:35:28', '2017-12-19 10:15:40', '2017-12-27 12:11:52');
INSERT INTO `admins` VALUES ('2', '2', 'qiantai', '4e7d2138ec68f460331e6d8ff06a72a0', '2017-12-19 10:16:06', '2017-12-19 10:16:10', '2017-12-27 12:11:56');
INSERT INTO `admins` VALUES ('3', '3', 'huiyuan', 'd0f5279ba63e0bf1901e81a69d2674b5', '2017-12-29 14:46:42', null, '2017-12-27 12:12:00');
INSERT INTO `admins` VALUES ('4', '4', 'cangku', '000e07f3dac80f02c75b960e3ef87b1c', '2017-12-28 10:45:44', null, '2017-12-27 12:12:05');
INSERT INTO `admins` VALUES ('5', '5', 'caiwu', 'f5b5ec699ed736de89336fbce0bc9890', '2018-01-02 18:36:21', null, '2017-12-27 12:12:11');
INSERT INTO `admins` VALUES ('6', '6', 'yuangong', '09b7d39592350b501433487e9a284fc3', '2017-12-28 10:55:54', null, '2017-12-27 12:11:36');
INSERT INTO `admins` VALUES ('8', '8', 'lvjunjiang', '911a5b04c2f7d48091b161dd06d6a2c3', '2017-12-28 10:56:54', '2017-12-27 12:08:21', null);
INSERT INTO `admins` VALUES ('9', '8', 'q', '7694f4a66316e53c8cdd9d9954bd611d', '2018-01-02 18:24:25', '2017-12-27 12:08:34', '2017-12-29 21:09:44');
INSERT INTO `admins` VALUES ('11', '7', 'sss', '77777777', null, '2017-12-28 21:37:37', '2017-12-29 10:44:51');
INSERT INTO `admins` VALUES ('12', '8', 'fhdf', 'qqqqqqqq', null, '2017-12-28 21:38:44', null);
INSERT INTO `admins` VALUES ('13', '8', 'qqq', 'qqqqqqqq', null, '2017-12-28 21:40:02', '2017-12-29 09:51:05');
INSERT INTO `admins` VALUES ('14', '8', 'pppp1', '44444444', null, '2017-12-29 08:48:47', '2017-12-29 08:59:21');
INSERT INTO `admins` VALUES ('15', '7', 'guy', '45454545', null, '2017-12-29 08:59:52', '2017-12-29 10:00:02');
INSERT INTO `admins` VALUES ('16', '8', 'dgd', '789456123', null, '2017-12-29 10:15:18', null);
INSERT INTO `admins` VALUES ('17', '7', 'QQ', 'wwwwwwww', null, '2017-12-29 10:16:01', '2017-12-29 10:21:32');
INSERT INTO `admins` VALUES ('18', '8', 'www', 'wwwwwwww', null, '2017-12-29 10:21:57', '2017-12-29 10:22:18');
INSERT INTO `admins` VALUES ('19', '7', 'ssss4', 'ssssssss', null, '2017-12-29 11:15:33', '2017-12-29 11:16:03');
...
-- Records of assets
-- ----------------------------
INSERT INTO `assets` VALUES ('1', '100000.00', '2018-01-01 09:10:53', null);
INSERT INTO `assets` VALUES ('2', '100124.00', '2018-01-02 10:15:14', null);
INSERT INTO `assets` VALUES ('3', '100144.00', '2018-01-02 10:34:46', null);
INSERT INTO `assets` VALUES ('4', '102034.00', '2018-01-02 10:45:16', null);
INSERT INTO `assets` VALUES ('5', '102070.00', '2018-01-02 11:46:30', null);
INSERT INTO `assets` VALUES ('6', '102718.00', '2018-01-02 11:51:13', null);
INSERT INTO `assets` VALUES ('7', '103418.00', '2018-01-02 12:31:23', null);
INSERT INTO `assets` VALUES ('8', '103724.00', '2018-01-02 13:55:01', null);
INSERT INTO `assets` VALUES ('9', '105362.00', '2018-01-02 16:37:54', null);
INSERT INTO `assets` VALUES ('10', '105383.00', '2018-01-02 16:40:27', null);
INSERT INTO `assets` VALUES ('11', '105479.00', '2018-01-02 17:08:11', null);
INSERT INTO `assets` VALUES ('12', '105779.00', '2018-01-02 17:08:11', null);
INSERT INTO `assets` VALUES ('13', '105479.00', '2018-01-02 17:37:02', null);
INSERT INTO `assets` VALUES ('14', '105672.00', '2018-01-02 17:37:52', null);
INSERT INTO `assets` VALUES ('15', '105972.00', '2018-01-02 17:37:52', null);
INSERT INTO `assets` VALUES ('16', '105603.00', '2018-01-02 17:38:56', null);

-- ----------------------------
-- Table structure for assetsdetal
-- ----------------------------
DROP TABLE IF EXISTS `assetsdetal`;
CREATE TABLE `assetsdetal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sn` varchar(255) DEFAULT NULL,
  `jinzhang` decimal(10,2) DEFAULT NULL,
  `chuzhang` decimal(10,2) DEFAULT NULL,
  `sum` decimal(11,0) DEFAULT NULL,
  `staffs` int(11) DEFAULT NULL,
  `creratedate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `staffs` (`staffs`),
  CONSTRAINT `assetsdetal_ibfk_1` FOREIGN KEY (`staffs`) REFERENCES `staffs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of assetsdetal
-- ----------------------------
INSERT INTO `assetsdetal` VALUES ('2', 'Aea7908dd31b64c5ba3bcd7fa36a9c6c3', '124.00', null, '100124', '8', '2018-01-02 10:15:14');
INSERT INTO `assetsdetal` VALUES ('3', 'A45a2d895b76b4606b8b40f67706341a3', '20.00', null, '100144', '8', '2018-01-02 10:34:46');
INSERT INTO `assetsdetal` VALUES ('4', 'A66653cf1119a4e5aa808bcf36e21a04c', '1890.00', null, '102034', '8', '2018-01-02 10:45:16');
INSERT INTO `assetsdetal` VALUES ('5', 'A4bb5bfbeb2324019ab77dd9b67d9602a', '36.00', null, '102070', '8', '2018-01-02 11:46:30');
INSERT INTO `assetsdetal` VALUES ('6', 'Ac54a8409b2774c01be9ce06fbae99ab2', '648.00', null, '102718', '8', '2018-01-02 11:51:13');
INSERT INTO `assetsdetal` VALUES ('7', 'Acb0cfe9dc2ec496eaf0391348d7043a2', '700.00', null, '103418', '8', '2018-01-02 12:31:23');
INSERT INTO `assetsdetal` VALUES ('8', 'Aa52c93d2b9a24f34bfe9e1ec7f22dd81', '306.00', null, '103724', '8', '2018-01-02 13:55:01');
INSERT INTO `assetsdetal` VALUES ('9', 'Ac4d53f1a8cf64031b823f43928d1bbb3', '1638.00', null, '105362', '8', '2018-01-02 16:37:54');
INSERT INTO `assetsdetal` VALUES ('10', 'A376cbef53b4f4e7aa0a3a45d9d404d83', '21.00', null, '105383', '8', '2018-01-02 16:40:27');
INSERT INTO `assetsdetal` VALUES ('11', 'A335f3e5e812b404b8d8dcd33f1e325a3', '96.00', null, '105479', '8', '2018-01-02 17:08:11');
INSERT INTO `assetsdetal` VALUES ('12', 'A2baa2a2b879e434b8addbdab50943b07', '300.00', null, '105779', '8', '2018-01-02 17:08:11');
INSERT INTO `assetsdetal` VALUES ('13', 'A3e37281782da4aa6868ea45b9b698b09', null, '300.00', '105479', '8', '2018-01-02 17:37:02');
INSERT INTO `assetsdetal` VALUES ('14', 'A4980d7bd90f94e6d94a129f2835c2f44', '193.00', null, '105672', '8', '2018-01-02 17:37:52');
INSERT INTO `assetsdetal` VALUES ('15', 'A84ad7d109b5949c6b6bec3e64cf48cc0', '300.00', null, '105972', '8', '2018-01-02 17:37:52');
INSERT INTO `assetsdetal` VALUES ('16', 'A4adddaa008834410bebcb9eef45b9e0d', null, '369.00', '105603', '8', '2018-01-02 17:38:56');
...
CREATE TABLE `caigou` (
  ...
  CONSTRAINT `caigou_ibfk_1` FOREIGN KEY (`staffs`) REFERENCES `staffs` (`id`),
  CONSTRAINT `caigou_ibfk_2` FOREIGN KEY (`entrepot`) REFERENCES `entrepot` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for caigoudittyitems
-- ----------------------------
DROP TABLE IF EXISTS `caigoudittyitems`;
CREATE TABLE `caigoudittyitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ditty` int(11) DEFAULT NULL,
  `dittynum` int(11) DEFAULT NULL,
  `caigou` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `caigou` (`caigou`),
  KEY `ditty` (`ditty`),
  CONSTRAINT `caigoudittyitems_ibfk_1` FOREIGN KEY (`caigou`) REFERENCES `caigou` (`id`),
  CONSTRAINT `caigoudittyitems_ibfk_2` FOREIGN KEY (`ditty`) REFERENCES `ditty` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of caigoudittyitems
-- ----------------------------

-- ----------------------------
-- Table structure for caigougoodsitems
-- ----------------------------
DROP TABLE IF EXISTS `caigougoodsitems`;
CREATE TABLE `caigougoodsitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `caigou` (`caigou`),
  KEY `goods` (`goods`),
  CONSTRAINT `caigougoodsitems_ibfk_1` FOREIGN KEY (`caigou`) REFERENCES `caigou` (`id`),
  CONSTRAINT `caigougoodsitems_ibfk_2` FOREIGN KEY (`goods`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of caigougoodsitems
-- ----------------------------
...
-- ----------------------------
-- Table structure for customercart
-- ----------------------------
...
CREATE TABLE `customercart` (
  ...
  KEY `user` (`user`),
  KEY `goods` (`goods`),
  CONSTRAINT `customercart_ibfk_1` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  CONSTRAINT `customercart_ibfk_2` FOREIGN KEY (`user`) REFERENCES `users` (`id`),
  CONSTRAINT `customercart_ibfk_3` FOREIGN KEY (`goods`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of customercart
-- ----------------------------

-- ----------------------------
-- Table structure for customerorderitems
-- ----------------------------
...
CREATE TABLE `customerorderitems` (
  ...
  KEY `room` (`room`),
  KEY `goods` (`goods`),
  CONSTRAINT `customerorderitems_ibfk_1` FOREIGN KEY (`orders`) REFERENCES `customerorders` (`id`),
  CONSTRAINT `customerorderitems_ibfk_2` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  CONSTRAINT `customerorderitems_ibfk_3` FOREIGN KEY (`goods`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of customerorderitems
-- ----------------------------
INSERT INTO `customerorderitems` VALUES ('1', '85', null, '4', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('2', '85', null, '5', '2', '5.00', '10');
INSERT INTO `customerorderitems` VALUES ('3', '85', null, '6', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('4', '89', null, '4', '2', '5.00', '10');
INSERT INTO `customerorderitems` VALUES ('5', '89', null, '5', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('6', '89', null, '6', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('7', '89', null, '2', '3', '5.00', '15');
INSERT INTO `customerorderitems` VALUES ('8', '95', null, '4', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('9', '95', null, '5', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('10', '95', null, '6', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('11', '95', null, '19', '1', '3.00', '3');
INSERT INTO `customerorderitems` VALUES ('12', '95', null, '17', '1', '3.00', '3');
INSERT INTO `customerorderitems` VALUES ('13', '97', null, '4', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('14', '97', null, '5', '2', '5.00', '10');
INSERT INTO `customerorderitems` VALUES ('15', '97', null, '6', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('16', '97', null, '3', '1', '4.00', '4');
INSERT INTO `customerorderitems` VALUES ('17', '99', null, '4', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('18', '99', null, '5', '2', '5.00', '10');
INSERT INTO `customerorderitems` VALUES ('19', '99', null, '6', '1', '5.00', '5');
INSERT INTO `customerorderitems` VALUES ('20', '99', null, '19', '1', '3.00', '3');
INSERT INTO `customerorderitems` VALUES ('21', '99', null, '27', '1', '5.00', '5');
...
CREATE TABLE `customerorders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sn` varchar(255) DEFAULT NULL,
  `usersputong` int(11) DEFAULT NULL,
  `room` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `sum` decimal(10,2) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `moditfydate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `customerorders_ibfk_2` (`room`),
  KEY `status` (`status`),
  KEY `usersputong` (`usersputong`),
  CONSTRAINT `customerorders_ibfk_2` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  CONSTRAINT `customerorders_ibfk_3` FOREIGN KEY (`status`) REFERENCES `orderstatus` (`id`),
  CONSTRAINT `customerorders_ibfk_4` FOREIGN KEY (`usersputong`) REFERENCES `usersputong` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of customerorders
-- ----------------------------
INSERT INTO `customerorders` VALUES ('84', 'O838461ad589946548d69a6183b8ae57c', '29', '1', '4', '124.00', '2018-01-02 10:15:14', '2018-01-02 10:34:46');
INSERT INTO `customerorders` VALUES ('85', 'O426ace92f6eb48d2b858d8b292db0285', null, '1', '2', '20.00', '2018-01-02 10:23:02', null);
INSERT INTO `customerorders` VALUES ('86', 'Of36ff3c8683d42209c1d88406cef766b', '29', '1', '4', '1366.00', '2018-01-02 10:41:06', '2018-01-02 10:41:25');
INSERT INTO `customerorders` VALUES ('87', 'Oaaa84f5a8f5d4c70b950602847f35d53', '29', '11', '4', '108.00', '2018-01-02 10:43:21', '2018-01-02 10:44:36');
INSERT INTO `customerorders` VALUES ('88', 'Of1c29c2da5af4d12a2f77fb2a3a21868', '29', '12', '3', '1890.00', '2018-01-02 10:45:16', null);
INSERT INTO `customerorders` VALUES ('89', 'O2f691ea1c114422d99ce274bf476364c', null, '12', '1', '35.00', '2018-01-02 10:47:32', null);
INSERT INTO `customerorders` VALUES ('90', 'Obe18341ebe504802b23204bb8b8e6860', '29', '60', '3', '36.00', '2018-01-02 11:46:29', null);
INSERT INTO `customerorders` VALUES ('91', 'O0a5039304d38419b8001634599312b81', '29', '50', '3', '648.00', '2018-01-02 11:51:13', null);
INSERT INTO `customerorders` VALUES ('92', 'O225d35a0694346cf9594bef7164c99c5', '29', '59', '3', '700.00', '2018-01-02 12:31:23', null);
INSERT INTO `customerorders` VALUES ('93', 'O4752a871673f429db71ca60c4ecf0fba', '29', '58', '3', '306.00', '2018-01-02 13:55:01', null);
INSERT INTO `customerorders` VALUES ('94', 'O4ba092f1342141649cb0b93da2efa1e7', '29', '21', '4', '1638.00', '2018-01-02 16:37:54', '2018-01-02 16:40:27');
INSERT INTO `customerorders` VALUES ('95', 'Ofcda6e96e0e94197973ecdfbc53d3c98', null, '21', '2', '21.00', '2018-01-02 16:38:47', null);
INSERT INTO `customerorders` VALUES ('96', 'O18104afe1e0f450aba1012dd127eef26', '29', '1', '4', '96.00', '2018-01-02 17:08:11', '2018-01-02 17:37:02');
INSERT INTO `customerorders` VALUES ('97', 'O70a9140afa55467ebcde4eff136277b2', null, '1', '2', '24.00', '2018-01-02 17:09:12', null);
INSERT INTO `customerorders` VALUES ('98', 'O8946364746e84f56b1ee3518eca4c392', '29', '1', '4', '193.00', '2018-01-02 17:37:52', '2018-01-02 17:38:56');
INSERT INTO `customerorders` VALUES ('99', 'O95e8f3be90ef4267acd222e6c1257448', null, '1', '2', '28.00', '2018-01-02 17:38:23', null);

-- ----------------------------
-- Table structure for ditty
-- ----------------------------
DROP TABLE IF EXISTS `ditty`;
CREATE TABLE `ditty` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `entrepot` (`entrepot`),
  CONSTRAINT `ditty_ibfk_1` FOREIGN KEY (`provider`) REFERENCES `provider` (`id`),
  CONSTRAINT `ditty_ibfk_2` FOREIGN KEY (`entrepot`) REFERENCES `entrepot` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ditty
-- ----------------------------
INSERT INTO `ditty` VALUES ('1', '牙刷', '一次性牙刷', '500', '1.00', '1', '1', '2017-12-21 13:07:52', '2017-12-23 13:07:58');
INSERT INTO `ditty` VALUES ('2', '被子', '白色棉被', '40', '50.00', '5', '1', '2017-12-12 18:36:51', null);
INSERT INTO `ditty` VALUES ('3', '床单', '棉质床单', '500', '20.00', '5', '1', '2017-12-26 18:38:00', null);
INSERT INTO `ditty` VALUES ('4', '纸巾', '维达纸巾', '500', '5.00', '2', '1', '2017-12-26 13:48:52', null);
INSERT INTO `ditty` VALUES ('5', '枕头', '软绵枕头', '500', '20.00', '1', '4', '2017-12-10 18:39:03', null);
...
CREATE TABLE `entrepot` (
  ...
  PRIMARY KEY (`id`),
  KEY `staff` (`staff`),
  CONSTRAINT `entrepot_ibfk_1` FOREIGN KEY (`staff`) REFERENCES `staffs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of entrepot
-- ----------------------------
INSERT INTO `entrepot` VALUES ('1', 'E001', '13475174418', '地下一层', '5');
INSERT INTO `entrepot` VALUES ('4', 'E002', '14578417458', '一楼储藏室', '5');
INSERT INTO `entrepot` VALUES ('6', 'E003', '14578417441', '二楼储藏室', '5');
INSERT INTO `entrepot` VALUES ('7', 'E004', '14578417887', '三楼储藏室', '4');
...
CREATE TABLE `goods` (
  ...
  KEY `entrepot` (`entrepot`),
  KEY `provider` (`provider`),
  CONSTRAINT `goods_ibfk_1` FOREIGN KEY (`type`) REFERENCES `goodstypes` (`id`),
  CONSTRAINT `goods_ibfk_3` FOREIGN KEY (`entrepot`) REFERENCES `entrepot` (`id`),
  CONSTRAINT `goods_ibfk_4` FOREIGN KEY (`provider`) REFERENCES `provider` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('1', '啤酒', '青岛啤酒', '119', '5.00', '4.00', '69ec2d16-fb3c-4aff-88d3-9a0206260f9f.jpg', '6', '2', '1', '0', '2017-12-11 14:15:30', '2017-12-27 15:34:43');
INSERT INTO `goods` VALUES ('2', '饮料', '各种芬达', '8', '6.00', '5.00', '0e4343b8-68e0-4a5f-be97-0ac9d8b0151f.jpg', '7', '2', '2', '0', '2017-12-12 14:15:35', '2017-12-27 11:54:39');
INSERT INTO `goods` VALUES ('3', '矿泉水', '农夫山泉', '398', '5.00', '4.00', 'b8383f6f-691b-4b86-9ca8-4c1a39ec77ea.jpg', '6', '2', '5', '0', '2017-12-13 14:15:39', '2017-12-27 11:54:53');
INSERT INTO `goods` VALUES ('4', '花生', '炒花生', '22', '6.00', '5.00', 'f7ac3419-6126-4a4b-a772-3f69cfd8b2ad.jpg', '7', '1', '5', '0', '2017-12-15 14:15:44', '2017-12-27 11:55:02');
INSERT INTO `goods` VALUES ('5', '瓜子', '五香瓜子', '56', '6.00', '5.00', 'e5d7e866-b1e4-4e9d-982d-eb6ab1ce51c8.jpg', '6', '1', '2', '0', '2017-12-16 14:15:48', '2017-12-27 11:55:15');
INSERT INTO `goods` VALUES ('6', '八宝粥', '银鹭八宝粥', '0', '6.00', '5.00', '8f8e025c-7d20-4501-a616-710bb1b11277.jpg', '6', '1', '1', '0', '2017-12-18 14:15:52', '2017-12-27 11:55:25');
INSERT INTO `goods` VALUES ('17', '测试', '测试数据', '49', '1.00', '3.00', 'd80a1b1f-8eed-4a99-990a-b5425153054a.jpg', '7', '2', '2', '0', '2017-12-25 11:37:56', '2017-12-27 10:07:19');
INSERT INTO `goods` VALUES ('18', '测试2', '测试测试', '60', '1.00', '3.00', '36427450-00ab-4ac6-baf8-89a81ac79887.jpg', '6', '2', '1', '0', '2017-12-25 11:42:20', '2017-12-27 10:07:26');
INSERT INTO `goods` VALUES ('19', '测试一下00', '测试数据', '797', '1.00', '3.00', 'b68e8ee2-7674-466b-83b1-87ed4f7ea28f.jpg', '6', '1', '5', '0', '2017-12-25 13:44:12', '2017-12-27 10:09:16');
INSERT INTO `goods` VALUES ('21', '测试一下10', '测试数据', '400', '1.00', '3.00', '001b0642-b1e9-493c-9031-9b8f767a8b70.jpg', '7', '2', '5', '0', '2017-12-25 17:19:52', '2017-12-29 10:57:57');
INSERT INTO `goods` VALUES ('23', '测试99', '测试数据', '340', '1.00', '3.00', '98c24720-e18c-4928-8e5c-3f155826a785.jpg', '6', '2', '1', '1', '2017-12-25 19:54:16', '2018-01-02 09:49:57');
INSERT INTO `goods` VALUES ('24', '测试上下架', '测试数据', '200', '200.00', '5.00', 'c28f9c5c-ffc9-40f5-a27a-f04f4d076fc4.jpg', '6', '2', '5', '1', '2017-12-27 09:03:19', '2017-12-28 13:46:11');
INSERT INTO `goods` VALUES ('25', '测试一下22', '测试测试', '500', '200.00', '5.00', '4346ccc3-ed2d-4a9b-9345-58180db5573f.jpg', '6', '2', '5', '1', '2017-12-27 11:53:15', '2017-12-29 10:47:59');
INSERT INTO `goods` VALUES ('27', '测试一下22', '测试数据', '259', '200.00', '5.00', '3fcbb9c0-b19a-4c07-84b5-4be3eaf42ee8.jpg', '7', '1', '1', '1', '2017-12-27 12:10:48', '2017-12-28 13:46:02');
INSERT INTO `goods` VALUES ('28', '花生粒', '炒花生米', '100', '200.00', '5.00', '5224786d-8c10-42af-a83c-835ffd0faee7.jpg', '4', '1', '1', '0', '2017-12-29 10:33:36', '2017-12-29 10:49:31');
...
CREATE TABLE `goodsimg` (
  ...
  PRIMARY KEY (`id`),
  KEY `goods` (`goods`),
  CONSTRAINT `goodsimg_ibfk_1` FOREIGN KEY (`goods`) REFERENCES `goods` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of goodsimg
-- ----------------------------
INSERT INTO `goodsimg` VALUES ('2', '81123cec-fc78-4ca6-8d2b-e6cbd8db7fd3.jpg', '17', '2017-12-25 11:37:56', null);
INSERT INTO `goodsimg` VALUES ('4', 'b76aac01-7d7b-4389-8983-e51c6f6aeef8.jpg', '17', '2017-12-25 11:37:56', null);
INSERT INTO `goodsimg` VALUES ('5', 'a6e22db2-d427-484b-ae9d-e0c8e7e9629e.jpg', '18', '2017-12-25 11:42:20', null);
INSERT INTO `goodsimg` VALUES ('6', 'e6346616-3261-4f10-8d6c-f705a7f63c43.jpg', '18', '2017-12-25 11:42:20', null);
INSERT INTO `goodsimg` VALUES ('7', 'be4a4a83-b3cc-4d8b-ae18-a791d41896db.jpg', '18', '2017-12-25 11:42:20', null);
INSERT INTO `goodsimg` VALUES ('8', '4da4466c-923c-4ae8-b8c9-c5a2757f803b.jpg', '19', '2017-12-25 13:44:12', null);
INSERT INTO `goodsimg` VALUES ('9', '6c0190b4-47ea-4407-b8ee-3c3e5d1f4be8.jpg', '19', '2017-12-25 13:44:12', null);
INSERT INTO `goodsimg` VALUES ('10', 'f99e0d29-2ac3-45ac-bbd3-f40f01e7a2c0.jpg', '19', '2017-12-25 13:44:12', null);
INSERT INTO `goodsimg` VALUES ('11', '69afb7d4-e5a9-49d8-a3a8-f5aa12f3fe7f.jpg', '21', '2017-12-25 17:19:52', null);
INSERT INTO `goodsimg` VALUES ('12', 'd88d7c8e-b0f6-4c36-a27d-06be1ab29349.jpg', '21', '2017-12-25 17:19:52', null);
INSERT INTO `goodsimg` VALUES ('46', '87401b62-d5a9-4441-9636-1485b027ac45.jpg', '21', '2017-12-17 14:02:55', '2017-12-26 10:15:03');
INSERT INTO `goodsimg` VALUES ('51', '37b4a5c2-5276-4f97-be84-8244a85053d7.jpg', '17', '2017-12-04 14:02:47', '2017-12-26 11:10:50');
INSERT INTO `goodsimg` VALUES ('53', '79aa4b31-3ea2-43ca-95a5-a5d132a1817d.jpg', '23', '2017-12-17 14:09:24', '2017-12-26 14:07:12');
INSERT INTO `goodsimg` VALUES ('54', '4402f098-5651-4dbf-b5a5-e79a298c0d01.jpg', '23', '2017-12-17 14:09:24', '2017-12-26 14:10:06');
INSERT INTO `goodsimg` VALUES ('55', 'e0f9788a-f4ea-4395-9287-8dded85993b9.jpg', '1', '2017-12-26 14:55:22', '2017-12-26 14:55:22');
INSERT INTO `goodsimg` VALUES ('56', 'bdc7076c-f122-459b-8bd6-94de027dafff.jpg', '1', '2017-12-26 14:55:22', '2017-12-26 14:55:22');
INSERT INTO `goodsimg` VALUES ('57', 'f769a2ea-703c-4515-aaa6-e94b16b01f1d.jpg', '1', '2017-12-26 14:55:22', '2017-12-26 14:55:22');
INSERT INTO `goodsimg` VALUES ('58', '985eee33-a837-4095-9f5c-b5da10a89daa.jpg', '24', '2017-12-27 09:03:19', null);
INSERT INTO `goodsimg` VALUES ('59', '9b941a86-107c-4a9e-b66e-80853f53359f.jpg', '24', '2017-12-27 09:03:19', null);
INSERT INTO `goodsimg` VALUES ('60', '1c08b486-19f3-4bf1-8cc6-8ea95a406e6f.jpg', '24', '2017-12-27 09:03:19', null);
INSERT INTO `goodsimg` VALUES ('61', '65923ac5-b52b-4475-8219-fa9e5bb7efbf.jpg', '25', '2017-12-27 11:53:15', null);
INSERT INTO `goodsimg` VALUES ('62', '4d787eef-c049-419e-87c7-2838201c0deb.jpg', '25', '2017-12-27 11:53:15', null);
INSERT INTO `goodsimg` VALUES ('63', 'ad97a6c8-dd93-4beb-9bc4-90dc5d777f0b.jpg', '25', '2017-12-27 11:53:15', null);
INSERT INTO `goodsimg` VALUES ('64', '82484503-b9e9-4267-a44f-f2ef3efd468e.jpg', '28', '2017-12-29 10:33:36', null);
INSERT INTO `goodsimg` VALUES ('65', 'b28b5ba1-a69d-4d11-af75-0c20cbf92a83.jpg', '28', '2017-12-29 10:33:36', null);
INSERT INTO `goodsimg` VALUES ('67', 'd5dc89af-5a91-4926-add9-0213ea679b99.jpg', '28', '2017-12-29 10:33:36', '2017-12-29 10:47:10');
...
-- ----------------------------
INSERT INTO `goodstypes` VALUES ('1', '小吃', '2017-12-10 14:13:26', '2017-12-22 14:13:30');
INSERT INTO `goodstypes` VALUES ('2', '饮品', '2017-12-17 14:13:38', '2017-12-23 14:13:43');
...
-- ----------------------------
INSERT INTO `orderstatus` VALUES ('1', '已经收货');
INSERT INTO `orderstatus` VALUES ('2', '已经结算');
INSERT INTO `orderstatus` VALUES ('3', '正常入住');
INSERT INTO `orderstatus` VALUES ('4', '入住离店');
INSERT INTO `orderstatus` VALUES ('5', '商品预定');
...
-- ----------------------------
INSERT INTO `permission` VALUES ('1', '查询房间', '/admin/qiantai/roomlist');
INSERT INTO `permission` VALUES ('2', '入住退房', '/admin/qiantai/userOut');
INSERT INTO `permission` VALUES ('3', '修改状态', '/admin/qiantai/alterRoomStatus');
INSERT INTO `permission` VALUES ('4', '查询消费', '/admin/qiantai/cartlist');
INSERT INTO `permission` VALUES ('5', '增加消费', '/admin/qiantai/cartadd');
INSERT INTO `permission` VALUES ('6', '修改消费', '/admin/qiantai/cartupdate');
INSERT INTO `permission` VALUES ('7', '编辑消费', '/admin/qiantai/cartedit');
INSERT INTO `permission` VALUES ('8', '删除消费', '/admin/qiantai/cartdelete');
INSERT INTO `permission` VALUES ('9', '查询订单', '/admin/qiantai/orderlist');
INSERT INTO `permission` VALUES ('10', '编辑订单', '/admin/qiantai/orderedit');
INSERT INTO `permission` VALUES ('11', '增加订单', '/admin/qiantai/orderadd');
INSERT INTO `permission` VALUES ('12', '修改订单', '/admin/qiantai/orderupdate');
INSERT INTO `permission` VALUES ('13', '删除订单', '/admin/qiantai/orderdelete');
INSERT INTO `permission` VALUES ('14', '查询房客', '/admin/qiantai/roomuserlist');
INSERT INTO `permission` VALUES ('15', '编辑房客', '/admin/qiantai/roomuseredit');
INSERT INTO `permission` VALUES ('16', '添加房客', '/admin/qiantai/roomuseradd');
INSERT INTO `permission` VALUES ('17', '修改房客', '/admin/qiantai/roomuserupdate');
INSERT INTO `permission` VALUES ('18', '删除房客', '/admin/qiantai/roomuserdelete');
INSERT INTO `permission` VALUES ('19', '查询会员', '/admin/qiantai/userlist');
INSERT INTO `permission` VALUES ('20', '添加会员', '/admin/qiantai/useradd');
INSERT INTO `permission` VALUES ('21', '编辑会员', '/admin/qiantai/useredit');
INSERT INTO `permission` VALUES ('22', '修改会员', '/admin/qiantai/userupdate');
INSERT INTO `permission` VALUES ('23', '删除会员', '/admin/qiantai/userdelete');
INSERT INTO `permission` VALUES ('24', '普客查询', '/admin/qiantai/userpukelist');
INSERT INTO `permission` VALUES ('25', '普客编辑', '/admin/qiantai/userpukeedit');
INSERT INTO `permission` VALUES ('26', '普客添加', '/admin/qiantai/userpukeadd');
INSERT INTO `permission` VALUES ('27', '普客修改', '/admin/qiantai/userpukeupdate');
INSERT INTO `permission` VALUES ('28', '普客删除', '/admin/qiantai/userpukedelete');
INSERT INTO `permission` VALUES ('29', '查询预订', '/admin/qiantai/roomselectlist');
INSERT INTO `permission` VALUES ('30', '编辑预订', '/admin/qiantai/roomselectedit');
INSERT INTO `permission` VALUES ('31', '添加预订', '/admin/qiantai/roomselectadd');
INSERT INTO `permission` VALUES ('32', '修改预订', '/admin/qiantai/roomselectupdate');
INSERT INTO `permission` VALUES ('33', '删除预订', '/admin/qiantai/roomselectdelete');
INSERT INTO `permission` VALUES ('34', '查询会员', '/admin/huiyuan/userlist');
INSERT INTO `permission` VALUES ('35', '编辑会员', '/admin/huiyuan/useredit');
INSERT INTO `permission` VALUES ('36', '添加会员', '/admin/huiyuan/useradd');
INSERT INTO `permission` VALUES ('37', '更改会员', '/admin/huiyuan/userupdate');
INSERT INTO `permission` VALUES ('38', '删除会员', '/admin/huiyuan/userdelete');
INSERT INTO `permission` VALUES ('39', '查询员工', '/admin/staffs/staffslist');
INSERT INTO `permission` VALUES ('40', '编辑员工', '/admin/staffs/staffsedit');
INSERT INTO `permission` VALUES ('41', '添加员工', '/admin/staffs/staffsadd');
INSERT INTO `permission` VALUES ('42', '修改员工', '/admin/staffs/staffsupdate');
INSERT INTO `permission` VALUES ('43', '删除员工', '/admin/staffs/staffsdelete');
INSERT INTO `permission` VALUES ('44', '查询仓库', '/admin/entrepot/entrepotList');
INSERT INTO `permission` VALUES ('45', '增加仓库', '/admin/entrepot/entrepotAdd');
INSERT INTO `permission` VALUES ('46', '编辑仓库', '/admin/entrepot/entrepotEdit');
INSERT INTO `permission` VALUES ('47', '修改仓库', '/admin/entrepot/entrepotUpdate');
INSERT INTO `permission` VALUES ('48', '删除仓库', '/admin/entrepot/entrepotDelete');
INSERT INTO `permission` VALUES ('49', '查询采购卖品', '/admin/caigou/goodslist');
INSERT INTO `permission` VALUES ('50', '编辑采购卖品', '/admin/caigou/goodsedit');
INSERT INTO `permission` VALUES ('51', '添加采购卖品', '/admin/caigou/goodsadd');
INSERT INTO `permission` VALUES ('52', '修改采购卖品', '/admin/caigou/goodsupdate');
INSERT INTO `permission` VALUES ('53', '删除采购卖品', '/admin/caigou/goodsdelete');
INSERT INTO `permission` VALUES ('54', '查询采购非卖', '/admin/caigou/dittylist');
INSERT INTO `permission` VALUES ('55', '添加采购非卖', '/admin/caigou/dittyadd');
INSERT INTO `permission` VALUES ('56', '修改采购非卖', '/admin/caigou/dittyupdate');
INSERT INTO `permission` VALUES ('57', '编辑采购非卖', '/admin/caigou/dittyedit');
INSERT INTO `permission` VALUES ('58', '删除采购非卖', '/admin/caigou/dittydelete');
INSERT INTO `permission` VALUES ('59', '查询卖品库存', '/admin/kucun/goodslist');
INSERT INTO `permission` VALUES ('60', '编辑卖品库存', '/admin/kucun/goodsedit');
INSERT INTO `permission` VALUES ('61', '添加卖品库存', '/admin/kucun/goodsadd');
INSERT INTO `permission` VALUES ('62', '修改卖品库存', '/admin/kucun/goodsupdate');
INSERT INTO `permission` VALUES ('63', '删除卖品库存', '/admin/kucun/goodsdelete');
INSERT INTO `permission` VALUES ('64', '查询维修', '/admin/repair/repairlist');
INSERT INTO `permission` VALUES ('65', '编辑维修', '/admin/repair/repairedit');
INSERT INTO `permission` VALUES ('66', '添加维修', '/admin/repair/repairadd');
INSERT INTO `permission` VALUES ('67', '修改维修', '/admin/repair/repairupdate');
INSERT INTO `permission` VALUES ('68', '删除维修', '/admin/repair/repairdelete');
INSERT INTO `permission` VALUES ('69', '查询供应商', '/admin/provider/providerList');
INSERT INTO `permission` VALUES ('70', '编辑供应商', '/admin/provider/providerEdit');
INSERT INTO `permission` VALUES ('71', '添加供应商', '/admin/provider/providerAdd');
INSERT INTO `permission` VALUES ('72', '修改供应商', '/admin/provider/providerUpdate');
INSERT INTO `permission` VALUES ('73', '删除供应商', '/admin/provider/providerDelete');
INSERT INTO `permission` VALUES ('74', '明细查询', '/admin/assets/assetsdetallist');
INSERT INTO `permission` VALUES ('75', '增加明细', '/admin/assets/assetsdetaladd');
INSERT INTO `permission` VALUES ('76', '编辑明细', '/admin/assets/assetsdetaledit');
INSERT INTO `permission` VALUES ('77', '修改明细', '/admin/assets/assetsdetalupdate');
INSERT INTO `permission` VALUES ('78', '删除明细', '/admin/assets/assetsdetaldelete');
INSERT INTO `permission` VALUES ('79', '查询采购单', '/admin/assets/caigoulist');
INSERT INTO `permission` VALUES ('80', '编辑采购单', '/admin/assets/caigouedit');
INSERT INTO `permission` VALUES ('81', '添加采购单', '/admin/assets/caigouadd');
INSERT INTO `permission` VALUES ('82', '修改采购单', '/admin/assets/caigouupdate');
INSERT INTO `permission` VALUES ('83', '删除采购单', '/admin/assets/caigoudelete');
INSERT INTO `permission` VALUES ('84', '浏览角色', '/admin/adminrole/adminroleslist');
INSERT INTO `permission` VALUES ('85', '编辑角色', '/admin/adminrole/adminrolesedit');
INSERT INTO `permission` VALUES ('86', '修改角色', '/admin/adminrole/adminrolesupdate');
INSERT INTO `permission` VALUES ('87', '添加角色', '/admin/adminrole/adminrolesadd');
INSERT INTO `permission` VALUES ('88', '删除角色', '/admin/adminrole/adminrolesdelete');
INSERT INTO `permission` VALUES ('89', '浏览管理员', '/admin/admin/adminlist');
INSERT INTO `permission` VALUES ('90', '编辑管理员', '/admin/admin/adminedit');
INSERT INTO `permission` VALUES ('91', '添加管理员', '/admin/admin/adminadd');
INSERT INTO `permission` VALUES ('92', '修改管理员', '/admin/admin/adminupdate');
INSERT INTO `permission` VALUES ('93', '删除管理员', '/admin/admin/admindelete');
INSERT INTO `permission` VALUES ('94', '校验角色', '/admin/adminrole/checkrolename');
INSERT INTO `permission` VALUES ('95', '校验管理员', '/admin/admin/checkadmin');
INSERT INTO `permission` VALUES ('96', '取房信息', '/admin/qiantai/roomUserMsg');
INSERT INTO `permission` VALUES ('97', '查询库存非卖', '/admin/kucun/dittylist');
INSERT INTO `permission` VALUES ('98', '添加库存非卖', '/admin/kucun/dittyadd');
INSERT INTO `permission` VALUES ('99', '修改库存非卖', '/admin/kucun/dittyupdate');
INSERT INTO `permission` VALUES ('100', '编辑库存非卖', '/admin/kucun/dittyedit');
INSERT INTO `permission` VALUES ('101', '删除库存非卖', '/admin/kucun/dittydelete');
INSERT INTO `permission` VALUES ('102', '状态过滤房间', '/admin/qiantai/findAllByStatues');
INSERT INTO `permission` VALUES ('103', '获取房间详情', '/admin/qiantai/getRoomById');
INSERT INTO `permission` VALUES ('104', '电话查会员', '/admin/qiantai/searchUserByPhone');
INSERT INTO `permission` VALUES ('105', '临客办理入住', '/admin/qiantai/transRoomInNoReverse');
INSERT INTO `permission` VALUES ('106', '结算退房', '/admin/qiantai/transRoomOut');
INSERT INTO `permission` VALUES ('107', '验证会员', '/admin/huiyuan/checkuser');
INSERT INTO `permission` VALUES ('108', '验证用户', '/admin/qiantai/searchUser1');
INSERT INTO `permission` VALUES ('109', '验证用户', '/admin/qiantai/searchUser2');
INSERT INTO `permission` VALUES ('110', '预定入住', '/admin/qiantai/findReverseByPhone');
INSERT INTO `permission` VALUES ('111', '类型查询', '/admin/qiantai/findAllByTypes');
INSERT INTO `permission` VALUES ('112', '管理员退出', '/admin/adminLoginOut');
INSERT INTO `permission` VALUES ('113', '查询用户入住历史', '/admin/qiantai/findUserByIdCard');
INSERT INTO `permission` VALUES ('114', '查询酒店在住人信息', '/admin/qiantai/findAllRoomUser');
...
CREATE TABLE `provider` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `providename` varchar(255) DEFAULT NULL,
  `providephone` varchar(255) DEFAULT NULL,
...
-- Records of provider
-- ----------------------------
INSERT INTO `provider` VALUES ('1', '张三峰', '17454784732', '上海市闵行区', '2017-12-21 16:49:12', '2017-12-22 16:49:19');
INSERT INTO `provider` VALUES ('2', '阿里巴巴集团', '14745147412', '     中国杭州 ', '2017-12-23 11:47:09', '2017-12-23 11:47:09');
INSERT INTO `provider` VALUES ('5', '京东', '17624713748', '郑州市经济开发区特一号', '2017-12-20 11:35:00', '2017-12-27 15:12:58');
...
CREATE TABLE `repair` (
  ...
  `ditty` int(255) DEFAULT NULL,
  `num` int(11) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `moditfydate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `repair_ibfk_1` (`room`),
  KEY `ditty` (`ditty`),
  CONSTRAINT `repair_ibfk_1` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  CONSTRAINT `repair_ibfk_2` FOREIGN KEY (`ditty`) REFERENCES `ditty` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of repair
-- ----------------------------
INSERT INTO `repair` VALUES ('1', '23', '灯泡坏了', null, null, '2018-01-02 15:22:35', null);
INSERT INTO `repair` VALUES ('2', '1', null, null, null, '2018-01-02 17:37:36', null);
INSERT INTO `repair` VALUES ('3', '1', null, null, null, '2018-01-02 17:44:04', null);
INSERT INTO `repair` VALUES ('4', '11', null, null, null, '2018-01-02 17:44:06', null);
INSERT INTO `repair` VALUES ('5', '21', null, null, null, '2018-01-02 17:44:09', null);

-- ----------------------------
-- Table structure for roomimgs
-- ----------------------------
DROP TABLE IF EXISTS `roomimgs`;
CREATE TABLE `roomimgs` (
  ...
  PRIMARY KEY (`id`),
  KEY `rooms` (`rooms`),
  CONSTRAINT `roomimgs_ibfk_1` FOREIGN KEY (`rooms`) REFERENCES `rooms` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rooms` (
  ...
  `phone` varchar(255) DEFAULT NULL,
  `imgcover` varchar(255) DEFAULT NULL,
  `roomstatus` int(255) DEFAULT NULL,
  ...
  CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`roomtype`) REFERENCES `roomtypes` (`id`),
  CONSTRAINT `rooms_ibfk_2` FOREIGN KEY (`roomstatus`) REFERENCES `roomstatus` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of rooms
-- ----------------------------
INSERT INTO `rooms` VALUES ('1', 'l101', '3', '0.00', '7474101', null, '2', '1', '127.0.0.1', null, null);
INSERT INTO `rooms` VALUES ('2', 'l102', '1', '200.00', '7474102', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('3', 'l103', '2', '0.00', '7474103', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('4', 'l104', '2', '0.00', '7474104', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('5', 'l105', '3', '0.00', '7474105', null, '2', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('6', 'l106', '3', '0.00', '7474106', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('7', 'l107', '4', '0.00', '7474107', null, '2', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('8', 'l108', '4', '600.00', '7474108', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('9', 'l109', '5', '2000.00', '7474109', null, '1', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('10', 'l111', '5', '0.00', '7474111', null, '7', '1', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('11', 'l201', '1', '0.00', '7474201', '', '2', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('12', 'l202', '1', '300000.00', '7474202', '', '4', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:53');
INSERT INTO `rooms` VALUES ('13', 'l203', '2', '0.00', '7474203', '', '1', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:57');
INSERT INTO `rooms` VALUES ('14', 'l204', '2', '0.00', '7474204', '', '1', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:01');
INSERT INTO `rooms` VALUES ('15', 'l205', '3', '0.00', '7474205', '', '7', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:04');
INSERT INTO `rooms` VALUES ('16', 'l206', '3', '0.00', '7474206', '', '5', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:07');
INSERT INTO `rooms` VALUES ('17', 'l207', '4', null, '7474207', '', '7', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:11');
INSERT INTO `rooms` VALUES ('18', 'l208', '4', '0.00', '7474208', '', '7', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:13');
INSERT INTO `rooms` VALUES ('19', 'l209', '5', '0.00', '7474209', '', '7', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:16');
INSERT INTO `rooms` VALUES ('20', 'l210', '5', '0.00', '7474210', '', '2', '2', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('21', 'l301', '1', '0.00', '7474201', '', '2', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('22', 'l302', '1', '0.00', '7474202', '', '7', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:53');
INSERT INTO `rooms` VALUES ('23', 'l303', '2', '0.00', '7474203', '', '2', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:57');
INSERT INTO `rooms` VALUES ('24', 'l304', '2', '0.00', '7474204', '', '7', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:01');
INSERT INTO `rooms` VALUES ('25', 'l305', '3', '0.00', '7474205', '', '5', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:04');
INSERT INTO `rooms` VALUES ('26', 'l306', '3', '0.00', '7474206', '', '7', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:07');
INSERT INTO `rooms` VALUES ('27', 'l307', '4', '0.00', '7474207', '', '7', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:11');
INSERT INTO `rooms` VALUES ('28', 'l308', '4', '0.00', '7474208', '', '7', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:13');
INSERT INTO `rooms` VALUES ('29', 'l309', '5', '2000.00', '7474209', '', '2', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:16');
INSERT INTO `rooms` VALUES ('30', 'l310', '5', '0.00', '7474210', '', '2', '3', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('31', 'l401', '1', '50.00', '7474201', '', '4', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('32', 'l402', '1', '0.00', '7474202', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:53');
INSERT INTO `rooms` VALUES ('33', 'l403', '2', '0.00', '7474203', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:57');
INSERT INTO `rooms` VALUES ('34', 'l404', '2', '0.00', '7474204', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:01');
INSERT INTO `rooms` VALUES ('35', 'l405', '3', '0.00', '7474205', '', '7', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:04');
INSERT INTO `rooms` VALUES ('36', 'l406', '3', '0.00', '7474206', '', '7', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:07');
INSERT INTO `rooms` VALUES ('37', 'l407', '4', '0.00', '7474207', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:11');
INSERT INTO `rooms` VALUES ('38', 'l408', '4', '0.00', '7474208', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:13');
INSERT INTO `rooms` VALUES ('39', 'l409', '5', '0.00', '7474209', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:16');
INSERT INTO `rooms` VALUES ('40', 'l410', '5', '0.00', '7474210', '', '2', '4', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('41', 'l501', '1', '0.00', '7474201', '', '5', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('42', 'l502', '1', '0.00', '7474202', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:53');
INSERT INTO `rooms` VALUES ('43', 'l503', '2', '0.00', '7474203', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:57');
INSERT INTO `rooms` VALUES ('44', 'l504', '2', '0.00', '7474204', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:01');
INSERT INTO `rooms` VALUES ('45', 'l505', '3', '0.00', '7474205', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:04');
INSERT INTO `rooms` VALUES ('46', 'l506', '3', '0.00', '7474206', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:07');
INSERT INTO `rooms` VALUES ('47', 'l507', '4', '0.00', '7474207', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:11');
INSERT INTO `rooms` VALUES ('48', 'l508', '4', '0.00', '7474208', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:13');
INSERT INTO `rooms` VALUES ('49', 'l509', '5', '0.00', '7474209', '', '2', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:16');
INSERT INTO `rooms` VALUES ('50', 'l510', '5', '300.00', '7474210', '', '4', '5', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('51', 'l601', '1', '0.00', '7474201', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');
INSERT INTO `rooms` VALUES ('52', 'l602', '1', '0.00', '7474202', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:53');
INSERT INTO `rooms` VALUES ('53', 'l603', '2', '0.00', '7474203', '', '7', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:49:57');
INSERT INTO `rooms` VALUES ('54', 'l604', '2', '0.00', '7474204', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:01');
INSERT INTO `rooms` VALUES ('55', 'l605', '3', '0.00', '7474205', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:04');
INSERT INTO `rooms` VALUES ('56', 'l606', '3', '0.00', '7474206', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:07');
INSERT INTO `rooms` VALUES ('57', 'l607', '4', '0.00', '7474207', '', '2', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:11');
INSERT INTO `rooms` VALUES ('58', 'l608', '4', '2000.00', '7474208', '', '4', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:13');
INSERT INTO `rooms` VALUES ('59', 'l609', '5', '300.00', '7474209', '', '4', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:16');
INSERT INTO `rooms` VALUES ('60', 'l610', '5', '300.00', '7474210', '', '4', '6', '127.0.0.1', '2017-12-21 11:44:26', '2017-12-21 11:50:31');

-- ----------------------------
-- Table structure for roomselect
-- ----------------------------
DROP TABLE IF EXISTS `roomselect`;
CREATE TABLE `roomselect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user` int(11) DEFAULT NULL,
  `room` int(11) DEFAULT NULL,
  ...
  KEY `user` (`user`),
  KEY `room` (`room`),
  CONSTRAINT `roomselect_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`),
  CONSTRAINT `roomselect_ibfk_2` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of roomselect
-- ----------------------------
INSERT INTO `roomselect` VALUES ('108', '25', '16', null, '20000.00', '2018-01-02 15:52:53', '2018-01-12 15:52:55');
INSERT INTO `roomselect` VALUES ('145', '37', '1', null, '138.00', '2018-01-02 00:00:00', '2018-01-03 00:00:00');
INSERT INTO `roomselect` VALUES ('146', '37', '2', null, '60.00', '2018-01-02 00:00:00', '2018-01-03 00:00:00');
...
-- ----------------------------
INSERT INTO `roomstatus` VALUES ('1', '房间不可用');
INSERT INTO `roomstatus` VALUES ('2', '房间空闲');
INSERT INTO `roomstatus` VALUES ('3', '房间已退-未清理');
INSERT INTO `roomstatus` VALUES ('4', '房间入住');
INSERT INTO `roomstatus` VALUES ('5', '房间入住-脏需清理');
INSERT INTO `roomstatus` VALUES ('6', '房间预定');
INSERT INTO `roomstatus` VALUES ('7', '房间维修');
...
-- ----------------------------
INSERT INTO `roomtypes` VALUES ('1', '标准单人间', '60.00');
INSERT INTO `roomtypes` VALUES ('2', '标准双人间', '80.00');
INSERT INTO `roomtypes` VALUES ('3', '大床单人间', '138.00');
INSERT INTO `roomtypes` VALUES ('4', '豪华套房', '340.00');
INSERT INTO `roomtypes` VALUES ('5', '钟点房', '40.00');

-- ----------------------------
-- Table structure for roomusers
-- ----------------------------
...
CREATE TABLE `roomusers` (
  ...
  KEY `room` (`room`),
  KEY `usersputong` (`usersputong`),
  CONSTRAINT `roomusers_ibfk_2` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  CONSTRAINT `roomusers_ibfk_3` FOREIGN KEY (`usersputong`) REFERENCES `usersputong` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of roomusers
-- ----------------------------
INSERT INTO `roomusers` VALUES ('67', '29', '12', '2018-01-02 10:45:16', '2018-02-06 14:00:00');
INSERT INTO `roomusers` VALUES ('68', '29', '60', '2018-01-02 11:46:29', '2018-01-02 14:00:00');
INSERT INTO `roomusers` VALUES ('69', '29', '50', '2018-01-02 11:51:13', '2018-01-20 14:00:00');
INSERT INTO `roomusers` VALUES ('70', '29', '59', '2018-01-02 12:31:23', '2018-01-27 14:00:00');
INSERT INTO `roomusers` VALUES ('71', '30', '59', '2018-01-02 12:31:23', '2018-01-27 14:00:00');
INSERT INTO `roomusers` VALUES ('72', '29', '58', '2018-01-02 13:55:01', '2018-01-02 14:00:00');
...
-- Records of sexs
-- ----------------------------
INSERT INTO `sexs` VALUES ('1', '男');
INSERT INTO `sexs` VALUES ('2', '女');
...
-- Records of staffs
-- ----------------------------
INSERT INTO `staffs` VALUES ('1', '001', 'zhangsan', '1', '12', '13285414646', '北京海淀', '前台接待', '4500.00', '2014-12-21 11:40:07', null);
INSERT INTO `staffs` VALUES ('2', '002', 'jack', '2', '22', '18341893956', '北京海淀', '商铺', '4500.00', '2016-10-01 11:40:07', null);
INSERT INTO `staffs` VALUES ('3', '003', 'rose', '2', '24', '18341895687', '北京海淀', '商铺', '4100.00', '2017-05-01 11:40:07', null);
INSERT INTO `staffs` VALUES ('4', '004', 'jeny', '2', '24', '18341896548', '北京海淀', '保洁', '4000.00', '2016-12-21 11:40:07', null);
INSERT INTO `staffs` VALUES ('5', '005', 'tony', '1', '26', '18341897564', '北京东城', '仓库管理', '5000.00', '2017-12-21 11:40:07', null);
INSERT INTO `staffs` VALUES ('6', '006', 'tom', '1', '28', '18345678945', '北京东城', '修理师傅', '5000.00', '2017-12-21 11:40:07', null);
INSERT INTO `staffs` VALUES ('7', '007', 'ceshi1', '2', '23', '183455655655', '北京丰台', '厕所清洁', '2000.00', '2017-12-27 09:14:51', null);
INSERT INTO `staffs` VALUES ('8', '008', 'ceshi2', '1', '45', '18346595965', '湖北襄阳', '大堂经理', '3000.00', '2013-12-29 11:04:52', null);
INSERT INTO `staffs` VALUES ('9', '009', 'ceshi3', '2', '32', '18346595974', '上海闵行', '厨师长', '20000.00', '2015-12-18 13:50:28', null);
INSERT INTO `staffs` VALUES ('10', '010', '测试4', '2', '32', '17451473241', '北京怀柔', '服务员', '2400.00', '2017-12-29 15:57:46', '2018-01-02 09:15:19');
INSERT INTO `staffs` VALUES ('12', 'san', 'zhangsan', '2', '22', '13285414545', '北京海淀四季青', '1231231231321', '6000.00', '2018-01-02 09:46:34', '2018-01-02 09:46:58');
INSERT INTO `staffs` VALUES ('13', '011', '成功', '1', '19', '174178', '美国旧金山', '厕所清洁', '7.00', '2018-01-02 10:00:33', null);

-- ----------------------------
-- Table structure for userroomorder
-- ----------------------------
DROP TABLE IF EXISTS `userroomorder`;
CREATE TABLE `userroomorder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userputong` int(11) DEFAULT NULL,
  `roomorder` int(11) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `moditfydate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `userputong` (`userputong`),
  KEY `roomorder` (`roomorder`),
  CONSTRAINT `userroomorder_ibfk_1` FOREIGN KEY (`userputong`) REFERENCES `usersputong` (`id`),
  CONSTRAINT `userroomorder_ibfk_2` FOREIGN KEY (`roomorder`) REFERENCES `customerorders` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of userroomorder
-- ----------------------------
INSERT INTO `userroomorder` VALUES ('13', '29', '84', '2018-01-02 10:15:14', '2018-01-02 10:34:46');
INSERT INTO `userroomorder` VALUES ('14', '29', '86', '2018-01-02 10:41:06', '2018-01-02 10:41:25');
INSERT INTO `userroomorder` VALUES ('15', '29', '87', '2018-01-02 10:43:21', '2018-01-02 10:44:36');
INSERT INTO `userroomorder` VALUES ('16', '29', '94', '2018-01-02 16:37:54', '2018-01-02 16:40:27');
INSERT INTO `userroomorder` VALUES ('17', '30', '94', '2018-01-02 16:37:54', '2018-01-02 16:40:27');
INSERT INTO `userroomorder` VALUES ('18', '29', '96', '2018-01-02 17:08:11', '2018-01-02 17:37:02');
INSERT INTO `userroomorder` VALUES ('19', '30', '96', '2018-01-02 17:08:11', '2018-01-02 17:37:02');
INSERT INTO `userroomorder` VALUES ('20', '29', '98', '2018-01-02 17:37:52', '2018-01-02 17:38:56');
INSERT INTO `userroomorder` VALUES ('21', '30', '98', '2018-01-02 17:37:52', '2018-01-02 17:38:56');
...
CREATE TABLE `users` (
  ...
  `address` varchar(255) DEFAULT NULL,
  `usersvip` int(11) DEFAULT NULL,
  `jifen` decimal(11,0) DEFAULT NULL,
  `num` int(11) DEFAULT NULL,
  `usersputong` int(11) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `moditfydate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `codetype` (`jifen`),
  KEY `users_ibfk_1` (`usersputong`),
  KEY `usersvip` (`usersvip`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`usersputong`) REFERENCES `usersputong` (`id`),
  CONSTRAINT `users_ibfk_2` FOREIGN KEY (`usersvip`) REFERENCES `usersvip` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('24', 'lvjunjiang', 'lvjunjiang', 'lvjunjiang', '88', '13285414943', '13285414943@qq.com', '浙江省金华市武义县', '7', '8888', '8888', '30', '2017-12-29 15:26:57', '2017-12-29 17:03:12');
INSERT INTO `users` VALUES ('25', 'liuyang', 'liuyang', 'liuyang', '45', '18341893958', '18340068548@139.com', '浙江省嘉兴市嘉善县', '4', '100', '100', '29', '2017-12-29 15:27:35', '2017-12-29 16:57:17');
INSERT INTO `users` VALUES ('26', 'zdfg', '45666789', 'gxdfzg', '78', 'gds', 'gsdg', '浙江省绍兴市绍兴县', '1', '0', '0', null, '2017-12-29 15:28:14', '2018-01-02 18:22:15');
INSERT INTO `users` VALUES ('27', 'qf', 'qqqqqqqqff', 'qqq1', 'qq', 'qq', 'q', '河南省南阳市社旗县', '1', '12', '0', null, '2017-12-29 15:28:47', '2018-01-02 18:22:49');
INSERT INTO `users` VALUES ('28', 'q', '44444444', 'afa', 'fasdf', 'aEFasef', 'fsdaafse', '浙江省嘉兴市嘉善县', '1', '0', '0', null, '2017-12-29 15:29:15', '2017-12-29 16:01:32');
INSERT INTO `users` VALUES ('29', 'sdgs', '44444444', 'dfsd', 'dfs', 'asdfafg', 'srgzsrg', '吉林省白山市江源县', '1', '0', '0', null, '2017-12-29 15:30:12', null);
INSERT INTO `users` VALUES ('30', 'g', '44444444', 'xcg', '78', '46546', 'fdgbd', null, '1', '60', '0', null, '2017-12-29 15:30:46', '2017-12-29 17:44:46');
INSERT INTO `users` VALUES ('31', 'xvcvb', 'qqqqqqqq', 'qqq1', 'dcv', 'fasc', 'asd', '福建省泉州市惠安县', '1', '55', '0', null, '2017-12-29 15:31:21', null);
INSERT INTO `users` VALUES ('32', 'csafc', '44444444', 'scac', 'dsgvsd', 'fvsd', 'sdgvs', '上海市县崇明县', '1', '30', '0', null, '2017-12-29 15:31:53', null);
INSERT INTO `users` VALUES ('33', 'vdfg', '44444444', 'jbvjh', 'kjh', 'kjhb', 'lkj', '黑龙江齐齐哈尔市龙江县', '1', '56', '0', null, '2017-12-29 15:36:16', null);
INSERT INTO `users` VALUES ('34', 'dgsd', '11111111', 'bhfshb', 'bd', 'dbfsd', 'dfbhsd', '江苏省盐城市响水县', '1', '700', '0', null, '2017-12-29 16:06:00', '2017-12-29 16:13:08');
INSERT INTO `users` VALUES ('35', 'rge', '1111222256', 'dfhd', '78', '1234567989', '165', '吉林省四平市梨树县', '1', '560', '0', null, '2017-12-29 16:59:50', '2018-01-02 18:21:56');
INSERT INTO `users` VALUES ('36', '78', '11111111', 'sdd', '44', '17839164704', '393699@qq.com', '上海市县崇明县', '1', '900', '0', null, '2017-12-29 17:44:28', null);
INSERT INTO `users` VALUES ('37', 'fang', 'fang', 'fangwenqi', '18', '1885446', '', '浙江省金华市武义县', null, '780', null, null, null, '2018-01-02 18:23:18');

-- ----------------------------
-- Table structure for usersnews
-- ----------------------------
DROP TABLE IF EXISTS `usersnews`;
CREATE TABLE `usersnews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `news` varchar(255) DEFAULT NULL,
  `answer` varchar(255) DEFAULT NULL,
  `customerorders` int(11) DEFAULT NULL,
  `staffs` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `customerorders` (`customerorders`),
  KEY `staffs` (`staffs`),
  CONSTRAINT `usersnews_ibfk_1` FOREIGN KEY (`customerorders`) REFERENCES `customerorders` (`id`),
  CONSTRAINT `usersnews_ibfk_2` FOREIGN KEY (`staffs`) REFERENCES `staffs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of usersnews
-- ----------------------------

-- ----------------------------
-- Table structure for usersputong
-- ----------------------------
DROP TABLE IF EXISTS `usersputong`;
CREATE TABLE `usersputong` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `sex` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `sex` (`sex`),
  CONSTRAINT `usersputong_ibfk_1` FOREIGN KEY (`sex`) REFERENCES `sexs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of usersputong
-- ----------------------------
INSERT INTO `usersputong` VALUES ('29', 'liuyang', '2', '142625199411143318');
INSERT INTO `usersputong` VALUES ('30', 'lvjunjiang', '1', '370682199507211619');
INSERT INTO `usersputong` VALUES ('31', 'alise', '1', '142625199411143319');
INSERT INTO `usersputong` VALUES ('32', '吕剧', '2', '212351625199411143315');
INSERT INTO `usersputong` VALUES ('33', '电风扇', '1', '321252652412596235');
INSERT INTO `usersputong` VALUES ('34', '电风扇', '1', '水电费开发推广');
INSERT INTO `usersputong` VALUES ('35', '12121', '1', '370682199507211619');
INSERT INTO `usersputong` VALUES ('36', '1221', '2', '370682199507211618');
INSERT INTO `usersputong` VALUES ('37', 'lyytu', '2', '获得改善服务');
INSERT INTO `usersputong` VALUES ('38', '', '1', '370682199507211617');
INSERT INTO `usersputong` VALUES ('39', '', '1', '421122199509011110');
...
CREATE TABLE `usersvip` (
  ...
  `roomdiscount` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
...
-- Records of usersvip
-- ----------------------------
INSERT INTO `usersvip` VALUES ('1', '0', '0', 'V0', '1.00');
INSERT INTO `usersvip` VALUES ('2', '10', '1', 'V1', '0.98');
INSERT INTO `usersvip` VALUES ('3', '30', '2', 'V2', '0.95');
INSERT INTO `usersvip` VALUES ('4', '60', '3', 'V3', '0.90');
INSERT INTO `usersvip` VALUES ('5', '100', '4', 'V4', '0.85');
INSERT INTO `usersvip` VALUES ('6', '200', '5', 'V5', '0.80');
INSERT INTO `usersvip` VALUES ('7', '201', '6', 'V6', '0.70');
