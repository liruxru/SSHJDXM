 ...
 * 
 * @see com.oracle.entity.Permission
...
public class PermissionDAO {
	...
	public Permission findById(java.lang.Integer id) {
		...
		try {
			Permission instance = (Permission) getCurrentSession().get(
					"com.oracle.entity.Permission", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Permission> findByExample(Permission instance) {
		...
		try {
			List<Permission> results = (List<Permission>) getCurrentSession()
					.createCriteria("com.oracle.entity.Permission")
	...
	public List<Permission> findByPername(Object pername) {
		return findByProperty(PERNAME, pername);
	}
