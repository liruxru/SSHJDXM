	...
	<script type="text/javascript">
	 $(function(){
	    $(".del").click(function(){
	          ...
	          url="${pageContext.request.contextPath}/admin/adminrole/adminrolesdelete";
	          if(confirm("是否删除")){
	           $.post(url,
	                 {"adminrole.id":id},
	                 function(res){	          
		   ...
		   <a href="${pageContext.request.contextPath}/admin/home">返回主页</a>
			<div class="center_top">
				<div style="float:right;padding-right:6px">
					...
					<a href="${pageContext.request.contextPath}/admin/adminrole/adminrolesedit">新增角色</a>&nbsp; 					
			...
			<div class="center_center">
				<div class="table_content">
					<table cellspacing="0px" cellpadding="0px">
						...
						<tbody>							
							<c:forEach items="${rolelist}" var="l" varStatus="v">
							<tr>
								<c:if test="${l.id ne 1}">
								...
								<td style="border-right:none">
									...
									<a href="${pageContext.request.contextPath}/admin/adminrole/adminrolesedit?adminrole.id=${l.id}">修改</a>&nbsp;
									<c:if test="${l.rolename ne '超级管理员' }">
